...
internal struct NodeViewInjectedTemplate: XcodeTemplate {
    ...
    internal let stencils: [StencilTemplate] = StencilTemplate.nodeStencils(withViewController: false)
