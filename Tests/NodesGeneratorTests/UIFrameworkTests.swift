...
final class UIFrameworkTests: XCTestCase {
    ...
    func testInitializeWithAppKitFramework() {
    ...
    func testInitializeWithUIKitFramework() {
    ...
    func testInitializeWithUIKitSwiftUIFramework() {
    ...
    func testInitializeWithCustomFramework() {
