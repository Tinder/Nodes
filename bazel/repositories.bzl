...
def nodes_dependencies():
    ...
    http_archive(
        ...
        build_file = "@Nodes//bazel:dependencies/ArgumentParser/BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "@Nodes//bazel:dependencies/Codextended/BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "@Nodes//bazel:dependencies/CwlCatchException/BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "@Nodes//bazel:dependencies/CwlPreconditionTesting/BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "@Nodes//bazel:dependencies/Needle/BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "@Nodes//bazel:dependencies/Nimble/BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "@Nodes//bazel:dependencies/PathKit/BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "@Nodes//bazel:dependencies/SnapshotTesting/BUILD",
    )
    ...
    http_archive(
        ...
        build_file = "@Nodes//bazel:dependencies/Stencil/BUILD",
    )
